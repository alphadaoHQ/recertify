...
export function loadNFTcollection$Data(slice: Slice) {
    ...
    return { $$type: 'NFTcollection$Data' as const, owner: _owner, maxsupply: _maxsupply };
}
...
async function NFTcollection_init(owner: Address, maxsupply: bigint) {
    const __code = Cell.fromHex('b5ee9c72410101010032000060ff00208e273030d072d721d200d200fa4021103450556f04f86101f862ed44d0fa40d31f596c125bdcf2c082e1f2c80b4ddf7e29');
    const builder = beginCell();
    initNFTcollection_init_args({ $$type: 'NFTcollection_init_args', owner, maxsupply })(builder);
...
const NFTcollection_types: ABIType[] = [
    ...
    {"name":"NFTcollection$Data","header":null,"fields":[{"name":"owner","type":{"kind":"simple","type":"address","optional":false}},{"name":"maxsupply","type":{"kind":"simple","type":"uint","optional":false,"format":32}}]},
]
...
export class NFTcollection implements Contract {
    ...
    static async init(owner: Address, maxsupply: bigint) {
        return await NFTcollection_init(owner, maxsupply);
    }
    
    static async fromInit(owner: Address, maxsupply: bigint) {
        const __gen_init = await NFTcollection_init(owner, maxsupply);
